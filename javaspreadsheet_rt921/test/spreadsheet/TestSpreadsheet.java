...
public class TestSpreadsheet {
  ...
  public void testParanthesis() throws Exception {
    Spreadsheet spreadsheet = new Spreadsheet();
    spreadsheet.setCellExpression(A1, "2");
    assertEquals(spreadsheet.evaluateExpression("2 * (3 + 2)"), 10, TOLERANCE);
    assertEquals(spreadsheet.evaluateExpression("a1 * (8 / (a1 + a1))"), 4, TOLERANCE);
  }
}
