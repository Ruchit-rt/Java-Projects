...
public class PictureProcessorTest {
  ...
  @Test
  public void mosaicRainbowSunsetGreen() throws IOException {
    Assert.assertEquals(
        new Picture("images/mosaicRainbowSunsetGreen.png"),
        TestSuiteHelper.runMain(
            tmpFolder, "mosaic", "3",
            "images/rainbow64x64doc.png", "images/sunset64x32.png", "images/green64x64doc.png"));
  }
}
